...
<link rel="stylesheet" type="text/css" href="../../Public/css/vehicule/vehicule.css">
...
<div class="fbody">
	...
	<form action="../../Routeur/addVehicule.php?i=<?php echo $id ?>&name=<?php echo $admin ?>&job=<?php echo $job ?>" method="post">
		<fieldset class="fieldset_champ" style="border-color:rgb(0,128,255);border-radius: 5px; ">
			<div >
				
				<input type="text" name="numVoi" placeholder="Saisir le numero de voiture" style="font-size: 12px; margin:10px;padding: 10px;width: 300px; border-radius: 6px;border-width: 1px;" required>
			</div>
			<div >
				
				<input type="text" name="typeVoi" placeholder="Saisir le type de voiture" style="font-size: 12px; margin:10px;padding: 10px;width: 300px; border-radius: 6px;border-width: 1px;" required>
			</div>

			<div >
				
				<input type="text" name="marqVoi" placeholder="Saisir la marque de voiture" style="font-size: 12px; margin:10px;padding: 10px;width: 300px; border-radius: 6px;border-width: 1px;" required>
			</div>

			<div >
				<input type="submit" value="ajouter" name="add" style="font-size: 15px;margin:16px;padding: 10px;border-radius: 6px;border-width: 1; background-color: rgb(0,128,255);width: 320px; border:none; color: white;">
			</div>
		</fieldset>
	...
	<table class="tab">
		...
		<?php 
		 ...
		 <tr>
		 	...
		 	<td><?= $val['marque'] ; ?></td>
		 	<td>
		 		<a class="a2" href="vehiculeEdit_view.php?i=<?php echo $id; ?> &v=<?= $val['idVehicule'] ; ?>">  Editer</a>
