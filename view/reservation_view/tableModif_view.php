							...
							<?php 
							 ...
							 <tr style="border: none;">
							 	...
							 	<td style="background-color:rgb(251,36,68);margin-left: 2px;margin-right: 2px;text-decoration: none;border-radius: 5px;">
							 		...
							 		<a style="text-decoration:none; color:white;" href="../../Routeur/valide.php?i=<?php echo $row['numRes']; ?>& numc=<?php echo $numc; ?>&name=<?php echo $admin ?>& dure=<?php echo $row['idDuree'] ?>& job=<?php echo $job ?>& ver=<?php echo "modif" ?>&val=<?php echo $val ?>& date1=<?php echo $dat1 ?>& date2=<?php echo $dat2 ?>" > Réalisé</a>
							 	</td>
							 </tr>
